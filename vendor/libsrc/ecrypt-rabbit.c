...
#include "eSTREAM_Project/ecrypt-portable.h"
...
/* Key setup */
void RABBIT_ECRYPT_keysetup(RABBIT_ECRYPT_ctx* ctx, const u8* key, u32 keysize, u32 ivsize)
{
   /* Temporary variables */
   u32 k0, k1, k2, k3, i;
...
/* IV setup */
void RABBIT_ECRYPT_ivsetup(RABBIT_ECRYPT_ctx* ctx, const u8* iv)
{
   /* Temporary variables */
   u32 i0, i1, i2, i3, i;
...
void RABBIT_ECRYPT_process_bytes(int action, RABBIT_ECRYPT_ctx* ctx, const u8* input, 
...
/* Generate keystream */
void RABBIT_ECRYPT_keystream_bytes(RABBIT_ECRYPT_ctx* ctx, u8* keystream, u32 length)
{
   /* Temporary variables */
   u32 i;
   u8 buffer[16];
...
void RABBIT_ECRYPT_process_blocks(int action, RABBIT_ECRYPT_ctx* ctx, const u8* input, 
